 ...
 */
package tech.cae.jmjcf.generator;
...
import tech.cae.jmjcf.generator.schema.Attribute;
...
public class Generator {
    ...
    private String pkg = "tech.cae.jmjcf";
    ...
    public ClassName handleElement(Element element, Deque<String> path, Set<String> nonUnique) throws SchemaException {
        ...
        if (!typeSpecs.containsKey(typeName)) {
            ...
            typeSpec.addSuperinterface(ClassName.bestGuess("tech.cae.jmjcf.types.MJCFType"));
            ...
            // Add include element
            typeSpec.addField(FieldSpec.builder(ParameterizedTypeName.get(ClassName.get(List.class), ClassName.bestGuess("tech.cae.jmjcf.types.Include")),
            ...
            typeSpec.addMethod(MethodSpec.methodBuilder("toString")
                    ...
                    .addCode("return tech.cae.jmjcf.MJCFIO.toString(this);\n").build());
            typeSpec.addMethod(MethodSpec.methodBuilder("equals")
                    .returns(TypeName.BOOLEAN)
                    .addModifiers(Modifier.PUBLIC, Modifier.FINAL)
                    .addParameter(Object.class, "other")
                    .addAnnotation(Override.class)
                    .addCode("return tech.cae.jmjcf.MJCFIO.equals(this, other);\n").build());
    ...
    public String getTypeName(Attribute attribute, Deque<String> path) throws SchemaException {
        switch (attribute.getType()) {
            case "reference":
                return "tech.cae.jmjcf.types.Reference";
            case "identifier":
                return "tech.cae.jmjcf.types.Identifier";
            case "basepath":
            case "file":
    ...
    public String getKeywordTypeName(Attribute attribute, Deque<String> path) throws SchemaException {
        switch(attribute.getValidValues()) {
            ...
            case "disable enable":
                return "tech.cae.jmjcf.types.Flag";
            default:
        }
        ...
        if(!typeSpecs.containsKey(typeName)) {
            ...
            TypeSpec.Builder typeSpec = TypeSpec.enumBuilder(ClassName.bestGuess(typeName))
                    ...
                    .addSuperinterface(ClassName.bestGuess("tech.cae.jmjcf.types.MJCFEnum"))
    ...
    public String getArrayTypeName(Attribute attribute, Deque<String> path) throws SchemaException {
        ...
        switch (path.peekLast()) {
            case "rgba":
                return "tech.cae.jmjcf.types.Color";
            default:
        }
        switch (name) {
            case "rgba":
            ...
            case "specular":
                return "tech.cae.jmjcf.types.Color";
            case "fromto":
                return "tech.cae.jmjcf.types.FromTo";
            case "pos":
                return "tech.cae.jmjcf.types.Pos";
            case "quat":
                return "tech.cae.jmjcf.types.Quat";
            case "axisangle":
                return "tech.cae.jmjcf.types.AxisAngle";
            case "xyaxes":
                return "tech.cae.jmjcf.types.XYAxes";
            case "zaxis":
                return "tech.cae.jmjcf.types.ZAxis";
            case "euler":
                return "tech.cae.jmjcf.types.Euler";
            default:
        }
        switch(arrayType) {
            case "float":
                return "tech.cae.jmjcf.types.FloatArray";
            case "int":
                return "tech.cae.jmjcf.types.IntArray";
        }
